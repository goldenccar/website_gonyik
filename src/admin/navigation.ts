...
export const ADMIN_REORDERABLE_GROUPS: AdminMenuGroup[] = [
  ...
  { id: 'technology', label: '技术创新', icon: Sun, children: [{ label: '页面配置', icon: FileText, path: '/admin/fluorine/config' }, { label: '技术创新内容管理', icon: Sun, path: '/admin/fluorine' }] },
...
export const ADMIN_FIXED_END: AdminMenuGroup[] = [
  { id: 'cms', label: 'CMS 管理', icon: SlidersHorizontal, children: [{ label: '模块排序', icon: SlidersHorizontal, path: '/admin/cms' }] },
]
