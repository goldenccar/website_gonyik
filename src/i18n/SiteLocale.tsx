...
export const ENGLISH_COPY: Record<string, string> = {
  ...
  '特种场景材料平台': 'Specialized material platform',
  ...
  '减少含氟依赖': 'Reducing fluorinated dependencies',
  '超微孔直接传递': 'Direct Micropore Transport',
  '强韧与耐候基础': 'Toughness & Weathering',
  'RPO-SOTEX 采用聚烯烃材料体系，从核心膜层减少对含氟材料的依赖。经 SGS 对数百种目标 PFAS 进行检测，结果均未检出。': 'RPO-SOTEX uses a polyolefin material system to reduce reliance on fluorinated materials at the core membrane layer. Hundreds of target PFAS tested by SGS were not detected.',
  ...
  '联系我们': 'Contact',
  '查看相关面料': 'View related fabrics',
  '从材料能力进入具体面料': 'Explore fabrics built on these capabilities',
  '进入面料数据库': 'Open the fabric database',
  '索取 TDS 与样品': 'Request TDS and samples',
  '当前咨询': 'Current enquiry',
  '查看 OTTER 系列面料': 'View the OTTER fabric series',
  '查看采用相关材料与工艺的 OTTER 系列现有型号与代表性性能。': 'Explore current OTTER styles and representative performance built on these materials and processes.',
  '进入面料数据库，按系列查看现有型号、材料结构与代表性性能。': 'Browse current styles, constructions and representative performance by series in the fabric database.',
  '查看 OTTER 系列型号': 'View OTTER styles',
  '查看 RAYO 系列型号': 'View RAYO styles',
  '查看 KAIS 系列型号': 'View KAIS styles',
  '进入面料数据库，查看该系列现有型号、材料结构与代表性性能。': 'Open the fabric database to review current styles, constructions and representative performance for this series.',
  ...
  '代表性样品典型值，具体结构、测试方法和适用条件以对应 TDS 为准。': 'Typical values for a representative sample. Refer to the corresponding TDS for the construction, test methods and conditions of use.',
  ...
  '港翼采购的相关面布具备 bluesign®、GRS、OEKO-TEX® 等认证基础，并结合材料批次、工艺条件与成品表现组织开发信息，为品牌选材、打样与后续交付提供清晰依据。': 'Relevant face fabrics sourced by GONYIK are supported by certifications including bluesign®, GRS and OEKO-TEX®. Material batches, process conditions and finished-fabric performance are organized together to provide clear references for material selection, sampling and subsequent delivery.',
