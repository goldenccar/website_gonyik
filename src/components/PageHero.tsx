...
export default function PageHero({ tag, title, subtitle, image, imageAlt = '', variant = 'section', className = '', children }: PageHeroProps) {
  if (variant === 'home') {
    return (
      <section className={`relative isolate min-h-[560px] overflow-hidden bg-dark px-6 lg:h-[620px] ${className}`}>
        ...
        <div className="mx-auto flex h-full min-h-[560px] w-full max-w-[1440px] items-center lg:min-h-0">
