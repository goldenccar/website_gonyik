...
| 文档 | 什么时候看 | 核心内容 |
|------|-----------|---------|
| **[AGENTS.md](./files/AGENTS.md)** | **Agent/开发者第一次接手项目** | 技术栈、设计规范、关键文件、部署工作流（含服务器信息、密码规则）、开发注意事项 |
| **[PRD.md](./files/PRD.md)** | 需要了解产品全貌、需求细节、技术架构时 | 产品需求文档：目标用户、设计原则、完整技术栈、页面模块详解、数据结构设计 |
| **[PROJECT_LOG.md](./files/PROJECT_LOG.md)** | 需要了解项目历史、当前功能清单、待办事项、启动方式时 | 项目决策记录、已实现功能、待办列表、`npm run dev/build` 命令 |
| **[CONTENT_STRATEGY.md](./files/CONTENT_STRATEGY.md)** | 需要撰写/修改品牌文案、理解产品定位时 | 品牌定位、信息架构、各页面文案规范、图片需求、SEO 关键词 |
...
我要了解产品做了什么、还有什么没做？
  └─→ 看 files/PROJECT_LOG.md

我要改文案、写内容、理解品牌定位？
  └─→ 看 files/CONTENT_STRATEGY.md
